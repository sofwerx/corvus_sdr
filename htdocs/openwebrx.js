...
{
	rx_photo_state=0;
	animate_to(e("webrx-top-photo-clip"),"maxHeight","px",0,0.93,1000,60,function(){resize_waterfall_container(true);});
...
function open_rx_photo()
{
	...
	animate_to(e("webrx-top-photo-clip"),"maxHeight","px",rx_photo_height,0.0,1000,60,function(){resize_waterfall_container(true);});
